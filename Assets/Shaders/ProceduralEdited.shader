...
Shader "Skybox/ProceduralEdited" {
Properties {
    ...
    _OuterRadius("Outer Radius", Range(1, 1.5)) = 1.01
    //_InnerRadius
    _InnerRadius("Inner Radius", Range(1, 1.5)) = 1.00
    //
    _SkyGround_Threshold("Sky Ground Threshold", Range(0,1)) = 0.01
}
...
SubShader {
    ...
    Pass {
        ...
        float _OuterRadius;
        float _InnerRadius;
        #define OUTER_RADIUS _OuterRadius
        static const float kOuterRadius = _OuterRadius;
        static const float kOuterRadius2 = _OuterRadius*_OuterRadius;
        static const float kInnerRadius = _InnerRadius;
        static const float kInnerRadius2 = _InnerRadius*_InnerRadius;
        ...
        float _SkyGround_Threshold;
        #define SKY_GROUND_THRESHOLD _SkyGround_Threshold
